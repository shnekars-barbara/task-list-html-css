...
<ol>
  <li> <code> git clone https://github.com/shnekars-barbara/task-list-html-css.git </code>, щоб клонувати репозиторій на локальний комп’ютер; </li>
...
<p>Проєкт використовує GitHub Actions для автоматичного розгортання оновленої версії вебзастосунка на GitHub Pages. <br>
